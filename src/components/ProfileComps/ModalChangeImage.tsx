...
//create a const that makes button with id='savePhoto' change profileImage in Profile.tsx
  ...
  return (
    <div>
      ...
      <Modal show={showModalImage} id='changeImage' size='lg' centered={true} keyboard={false} onHide={handleCloseModalImage} className='border border-primary-subtle border-5 rounded-5 opacity-75'>
